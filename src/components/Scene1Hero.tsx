...
const slides = [
  {
    ...
    sub: 'That was the easy part.',
    accentWord: 'easy part',
  },
  {
  ...
  },
  {
    ...
    sub: 'The production intelligence layer.',
    accentWord: 'production intelligence',
  },
];
        ...
        >
          <AnimatePresence mode="wait">
            ...
            >
              ...
              >
                {renderSub(slide.sub, slide.accentWord)}
              </p>
            </motion.div>
          </AnimatePresence>
        </div>
